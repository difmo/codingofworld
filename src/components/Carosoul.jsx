...
const CarouselContent = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      content: "Gain real-world experience in full-stack development through our immersive coding bootcamps. Get ready for a high-demand career in tech!",
    },
    {
      ...
      content: " Join our interactive workshops and become proficient in the latest web technologies like React, Node.js, and more!",
    },
  ];

  useEffect(() => {
    // Set up the interval to run handlePrev every 2 seconds
  ...
  return (
    <div className="flex flex-col items-center justify-center p-10">
      <div className="flex-col flex md:flex-row w-full max-w-4xl mx-auto">
        ...
        <div className="md:w-1/2 w-full h-64 flex items-center justify-center bg-white p-4 shadow-md">
