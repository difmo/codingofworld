...
int main() {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md text-gray-800 dark:bg-gray-800 dark:text-gray-200 container py-40">
      ...
      <pre className="bg-gray-100 p-2 rounded overflow-x-auto">{cCode1}</pre>
      <button onClick={() => copyToClipboard(cCode1)} className="text-gray-600 hover:text-gray-800">
      ...
      <h4 className="mt-4 font-semibold">Code Explanation:</h4>
      <pre className="bg-gray-100 p-2 rounded overflow-x-auto">{cCode2}</pre>
      <button onClick={() => copyToClipboard(cCode2)} className="text-gray-600 hover:text-gray-800">
        {copySuccess ? <FaClipboardCheck /> : <FaCopy />}
      </button>
