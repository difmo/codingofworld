...
const AdminPricing = () => {
  ...
  return (
    <div className="admin-panel bg-gray-100 p-6 rounded-lg shadow-md">
      ...
      <div className="pricing-list bg-white p-6 rounded-lg shadow-lg overflow-x-auto">
  <h3 className="text-2xl font-semibold mb-4">Existing Pricing Plans</h3>
  <div className="flex space-x-4 whitespace-nowrap">
    {pricingPlans.map((plan) => (
      <div key={plan.id} className="pricing-plan mb-4 p-4 border rounded-md shadow-sm inline-block">
