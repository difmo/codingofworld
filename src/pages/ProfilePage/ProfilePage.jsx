      ...
      <div className="w-full h-full mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        {isUserLogin && (
          <div className="text-right mt-4">
            ...
            {!blogPermission ? (
              ...
              <div>
                <div className="flex items-center text-gray-700 cursor-pointer font-play hover:text-blue-600 py-4">
                  <FaBlog className="mr-3" />
                  <div>
                  ...
                  <FaBlog className="mx-3" />
                </div>
                <div className="flex items-center text-gray-700 cursor-pointer font-play hover:text-blue-600">
                  <FaDiscourse className="mr-3 " />
                  <div>
                    <span onClick={() => navigate("/all-course")}>
                      Create Courses
                    </span>
                  </div>
                </div>
        ...
        {studentData && (
          <div className="mt-8 space-y-6">
            ...
            {isCertificateVisible && (
              <CertificatesGeneratorComponent name={name} />
            )}
          </div>
        )}
      </div>
