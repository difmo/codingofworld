...
const featuresData = [
  {
    ...
    description: "Learn to create stunning mobile applications for both Android and iOS platforms."
  },
  {
    id: 2,
    icon: <FaLaptopCode size={48} />,
    title: "Web Development",
    description: "Master the art of building responsive and dynamic websites using modern frameworks."
  },
  {
    id: 3,
    icon: <FaDatabase size={48} />,
    title: "Data Science & AI",
    description: "Get hands-on experience with data analysis, machine learning, and AI technologies."
  },
  {
    id: 4,
    icon: <FaGamepad size={48} />,
    title: "Game Development",
    description: "Dive into the world of game design and development with industry-standard tools."
  },
  {
    id: 5,
    icon: <FaCloud size={48} />,
    title: "Cloud Computing",
    description: "Understand cloud architecture and services to deploy and manage applications."
  },
  {
    id: 6,
    icon: <FaShieldAlt size={48} />,
    title: "Cybersecurity",
    description: "Learn essential security practices to protect applications and data from threats."
  },
  {
    id: 7,
    icon: <FaPaintBrush size={48} />,
    title: "UI/UX Design",
    description: "Explore design principles to create user-friendly and visually appealing interfaces."
  },
  {
    id: 8,
    icon: <FaTools size={48} />,
    title: "DevOps Practices",
    description: "Implement DevOps methodologies for continuous integration and deployment."
  },
  {
    id: 9,
    icon: <FaLink size={48} />,
    title: "Blockchain Development",
    description: "Discover the fundamentals of blockchain technology and smart contracts."
  },
  {
    id: 10,
    icon: <FaBullhorn size={48} />,
    title: "Digital Marketing",
    description: "Learn strategies to promote applications and websites effectively online."
  },
];
